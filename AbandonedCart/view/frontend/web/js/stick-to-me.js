...
(function ($) {
    ...
    $.stickToMe = function ( configs ) {
        ...
        function showbox()
        {
            if ($.data(document.body, "stick_var") != 1) {
                ...
                $('<div class="visionet_abandoned_cart_stick_block_layer"></div>').appendTo('body').css(settings.backgroundcss).fadeIn(settings.fadespeed);
                ...
                if (settings.bgclickclose) {
                    $('.visionet_abandoned_cart_stick_block_layer').click(
                        function () {
                            stick_close();
                        }
                    );
    ...
    function stick_close()
    {
        ...
        $('.visionet_abandoned_cart_stick_block_layer').fadeOut(
            function () {
                $(this).remove(); }
        );
