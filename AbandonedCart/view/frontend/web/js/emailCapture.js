define(
    ['jquery', 'domReady!'], function ($) {
        ...
        {
            $('body').on(
                'click', '.stick_container #visionet_abandoned_cart_stick_layer .save', function (ele) {
                    var email = $('.stick_container #visionet_abandoned_cart_stick_layer #exit-email').val();
                    var message = $('.stick_container #visionet_abandoned_cart_stick_layer .message');
                    if (email && validateEmail(email)) {
                        $('body').loader('show');
                        message.hide();
                        $.post(
